...
let comment_video = [];
const MobileVideoDetails = ({profileImage,company,productImage,username,videoRef,onVideoClick,sendComment,video,likePost,comment,hasLikes,setIsLoadVideo,comments,setComment}) => {
    ...
    return(
        ...
        >
            ...
            >
              <div style={{borderRadius:'10px',border:'1px solid gray',padding:8}} className="bg-gray-200">
        ...
        <div
          className='h-60 overflow-y-scroll scrollbar-thin scrollbar-hide'
        >
          {videoComment.map((comment) => (
            ...
            >
              ...
              <p className="text-sm flex-1">
                ...
                <Grid style={{display:'flex',justifyContent:'center',alignItems:'center',flexFlow:'row',gap:5}}>
                  <button
                  ...
                  />
                  <div style={{display:'flex',flexFlow:'row',justifyContent:'center',gap:15,padding:10}} className='rounded-xl bg-gray-300'>
                  <IoIosSend className="text-black text-[30px]" onClick={sendComment}/>
                  {hasLikes ? (
                        <motion.div
